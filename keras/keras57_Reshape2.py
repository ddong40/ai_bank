#conv2d로 시작해서 중간에 lstm 넣어서 모델구성 밑에 
...
model.add(Conv2D(10, 3, input_shape=(28,28, 1), padding='same')) #(n, 28, 28)
model.add(Conv2D(64, (3,3) )) # 28, 28, 10
model.add(MaxPooling2D()) #26 26 64 
model.add(Reshape(target_shape=(169, 64))) # 13 13 64
model.add(LSTM(units=10, input_shape = (169, 64))) 
# # model.add(Reshape(target_shape=(169*10,)))
# # model.add(Reshape(target_shape=(10*182,))) #(500,)
