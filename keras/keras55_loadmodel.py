...
# model.fit(x_train, y_train, epochs=10000, batch_size=400, verbose=1, validation_split = 0.1, callbacks=[es] ) 
# model.save("./_save/keras55/jena_전사영.h5")

model = load_model('./_save/keras55/jena_전사영.h5')
...
sampleSubmission.to_csv(path2+'jena_전사영.csv') 
