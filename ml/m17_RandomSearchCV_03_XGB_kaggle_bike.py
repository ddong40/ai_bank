...
# 최적의 파라미터 :  {'n_jobs': -1, 'min_samples_leaf': 3, 'max_depth': 10, 'learning_rate': 0.01}
print('최고의 점수 : ', model.best_score_) 
# 최고의 점수 :  0.29675897452834754
print('모델의 점수 : ', model.score(x_test, y_test)) 
# 모델의 점수 :  0.3154557717201385
y_predict = model.predict(x_test)

print('accuracy_score : ', r2_score(y_test, y_predict)) 
# accuracy_score :  0.3154557717201385
y_pred_best = model.best_estimator_.predict(x_test) 

print('최적 튠 ACC: ', r2_score(y_test, y_pred_best)) 
# 최적 튠 ACC:  0.3154557717201385
