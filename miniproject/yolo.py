...
def detectAndDisplay(frame):
    ...
    # 값이 변경되었는지 확인 (이벤트는 1초에 한 번만 트리거)
    ...
    # if (current_time - last_event_time >= 1):  # 1초에 한 번씩만 체크
    #     if current_car_count != previous_car_count or current_parking_lot != previous_parking_lot:
    #         value_changed_event.set()  # 이벤트 신호를 보냄
    #     last_event_time = current_time  # 이벤트 시간 업데이트
...
def handle_value_change():
    ...
    while True:
        ...
        data = {
            ...
            "empty_spots": 4 - current_car_count
        }
