...
response_templates = load_template_from_csv('C:/Users/baenoori/Downloads/시나리오test1029 - 시트1.csv')
...
def chat(user_question):
    global missing_info, reservation_info, confirmation_stage
...
while True:
    ...
    if confirmation_stage:
        if user_input.lower() == "아니요":
            ...
            # select_response_template(user_input)
            continue
