...
path = './텐서플로 자격증 문제 정리 1127/Category5_Weekly/'

# COMPLETE THE CODE IN THIS FUNCTION
def solution_model():
    # DO NOT CHANGE THIS CODE
    # Reads the dataset.
    df = pd.read_csv(path + 'Weekly_U.S.Diesel_Retail_Prices.csv',
    ...
    model = tf.keras.models.Sequential([
        tf.keras.layers.LSTM(256, return_sequences=True, input_shape = [N_PAST, N_FEATURES]),
