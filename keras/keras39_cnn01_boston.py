...
start = time.time()
hist = model.fit(x_train, y_train, epochs=100, batch_size=32, verbose=1, validation_split = 0.3, callbacks=[es, mcp])
end = time.time()
...
# gnn을 cnn으로 변환
# 로스 :  15.58898639678955
# r2 score : 0.8335030621093346
# 시간 :  6.121 초