...
# dense3 = Dense(64, name = 'ys3', activation = 'relu')(drop2)
# drop3 = Dropout(0.2)(dense3)
# dense4 = Dense(64, name = 'ys4', activation = 'relu')(drop3)
# drop4 = Dropout(0.2)(dense4)
# dense5 = Dense(64, name = 'ys5', activation = 'relu')(drop4)
# drop5 = Dropout(0.2)(dense5)
# dense6 = Dense(32, name = 'ys6', activation = 'relu')(drop5)
# drop6 = Dropout(0.2)(dense6)
# dense7 = Dense(32, name = 'ys7', activation = 'relu')(drop6)
# drop7 = Dropout(0.2)(dense7)
# dense8 = Dense(16, name = 'ys8', activation = 'relu')(drop7)
# drop8 = Dropout(0.2)(dense8)
# output1 = Dense(1, activation = 'sigmoid')(drop8)
...
model = Sequential()
model.add(Conv2D(32, 2, activation='relu', input_shape=(10,3,1), padding='same'))
model.add(Dropout(0.2))
...
#cpu
# 로스 :  0.0049362340942025185
# ACC :  0.994
# acc스코어 :  0.9941520467836257
# 걸린시간 :  1.36 초

#gpu
# 로스 :  0.014576924033463001
# ACC :  0.977
# acc스코어 :  0.9766081871345029
# 걸린시간 :  4.08 초

# gnn에서 cnn으로
# 로스 :  0.016991790384054184
# ACC :  0.977
# 걸린시간 :  5.19 초