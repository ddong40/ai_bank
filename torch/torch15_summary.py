...
#127.5를 중심으로 잡아서 사용하는 것임 그래서 음수도 사용 (Z Score-정규화라고 말하기도 함)
...
# model.summary() # Tensorflow는 요거야

print(model)

from torchsummary import summary
# summary(model, (28, 28, 1)) #이렇게 넣으면 안됌
