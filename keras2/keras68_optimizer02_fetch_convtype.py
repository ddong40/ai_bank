...
for i in lr:
    ...
    model.fit(x_train, y_train, epochs=1000, batch_size=300, verbose=0 , validation_split=0.25, callbacks=[es, mcp])
    end_time = time.time()
...
# 0.1 : 
# 로스값 :  1.205340027809143
# 정확도 :  0.4876021146774292
# ----------------------------
# 0.01 : 
# 로스값 :  1.2051646709442139
# 정확도 :  0.4876021146774292
# ----------------------------
# 0.005 : 
# 로스값 :  1.2051677703857422
# 정확도 :  0.4876021146774292
# ----------------------------
# 0.001 : 
# 로스값 :  1.2051582336425781
# 정확도 :  0.4876021146774292
# ----------------------------
# 0.0005 : 
# 로스값 :  1.2051626443862915
# 정확도 :  0.4876021146774292
# ----------------------------
# 0.0001 : 
# 로스값 :  1.2051584720611572
# 정확도 :  0.4876021146774292
# ----------------------------