...
def solution_model():
    ...
    model = tf.keras.models.Sequential([
        ...
        tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(19, return_sequences=True),
                                      input_shape=(N_PAST, N_FEATURES)),
        tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(97, return_sequences=True)),
        tf.keras.layers.TimeDistributed(tf.keras.layers.Dense(9, activation='relu')),
        tf.keras.layers.TimeDistributed(tf.keras.layers.Dense(21, activation='relu')),
