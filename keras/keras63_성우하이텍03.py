...
dense1 = Bidirectional(LSTM(10, return_sequences= True, activation='relu', name='bit1'))(input1)
dense2 = Conv1D(32, 2, activation='relu', name='bit2')(dense1)
...
dense11 = Bidirectional(LSTM(10, return_sequences= True, activation='relu', name='bit11'))(input11)
dense21 = Conv1D(32, 2, activation='relu', name='bit21')(dense11)
