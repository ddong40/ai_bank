...
conv2d1 = Conv2D(64, 2, activation='relu', strides=1, padding='same')(input1)
maxpool = MaxPooling2D()(conv2d1)
conv2d2 = Conv2D(64, 2, activation='relu', strides=1, padding='same')(maxpool)
drop1 = Dropout(0.2)(conv2d2)
conv2d3 = Conv2D(32, 2, activation='relu', strides=1, padding='same')(drop1)
drop2 = Dropout(0.2)(conv2d3)
