...
# print(x_test.shape) (49511, 10)

# print(x_test)
# print(test_csv)

x_train = x_train.reshape(115523, 5, 2, 1)
x_test = x_test.reshape(49511, 5, 2, 1)
...
model.fit(x_train, y_train, epochs= 100, batch_size=100, verbose=1, validation_split= 0.25, callbacks=[es, mcp])
end_time = time.time()
...
# dnn - cnn으로 변환
# 로스 :  0.3281129002571106
# acc :  0.8632223010063171
# 걸린시간 :  446.49 초